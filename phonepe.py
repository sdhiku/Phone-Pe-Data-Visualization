...
df2 = pd.read_csv('D:/Project/2PHONEPE/bar_chart.csv')

# Read the "Histogram_district" CSV file into a DataFrame :
df3 = pd.read_csv('D:/Project/2PHONEPE/histogram_district.csv')
...
def main():
    ...
    # Create sidebar with select options
    option = st.sidebar.radio('Select Visualization of Users Analysis', ('Users Analysis', 'top_user_by_type','None'))
